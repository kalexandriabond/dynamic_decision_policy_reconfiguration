...
av_manifold_df = pd.read_csv('~/Dropbox/loki_0/simple_rt_experiment_probabilityC/analysis/aggregated_data/av_est.csv')
...
for subj_id in sub_mean_av_df.subj_id.unique():
    ...
    plot_a_v_time(sub_data, fig, ax, conditional=False, savefig=True, all_subs=True, legend=False, id_str='loki_0')
